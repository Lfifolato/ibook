...
namespace ibook.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,titulo,descricao,Genero,quantPag,datalancamento")] Livros livros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,titulo,descricao,Genero,quantPag,datalancamento")] Livros livros)
        {
            if (id != livros.Id)
            {
                return NotFound();
